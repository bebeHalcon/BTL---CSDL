                                        ...
                                        <tbody>
                                            ...
                                            foreach ($comments as $comment) {
                                                ...
                                                "<tr class=\"text-center\">
                                                    ...
                                                    $button . "
                                                    <button data-toggle='tooltip' data-placement='top' title='Xóa bình luận' class=\"btn-delete btn btn-danger btn-xs\" style=\"margin-right: 5px\" data-id='$comment->id' ><i style=\"font-size:17px;\" class=\"fas fa-trash\"></i></button>
                                                  </td>                                                                                                                                                                                       
                                                </tr>";
                                                $index++;
                                            }
